      ...
      <DropdownWithAutosuggest
        ...
        input={({ getInputProps }) => (
          <input
            {...getInputProps({
              placeholder: "Select number",
              className: "text-grey-dark outline-none px-10 py-15 border-grey-2 rounded border focus:border-grey-4 focus:outline-none hover:border-grey-3 hover:transition duration-200"
            })}
          />
        )}
      />
