      ...
      {createElement(
        tag || isWrapped ? "div" : "button",
        {
          ...
          className: classnames(
            "flex w-12/12 justify-center items-center text-center text-black leading-xs transition duration-200 cursor-pointer font-bold text-base focus:outline-none",
            {
