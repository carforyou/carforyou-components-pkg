...
var transform_1 = __importDefault(require("./plugins/transform"));
...
exports.default = {
    theme: {
       ...
       */
        ...
        */
        ...
        |
        */
        linearGradients: function (theme) { return ({
            directions: {
                "to-top": "to top",
                "to-right": "to right",
                "to-bottom": "to bottom",
    ...
    plugins: [transform_1.default, require("tailwindcss-gradients")()],
};
